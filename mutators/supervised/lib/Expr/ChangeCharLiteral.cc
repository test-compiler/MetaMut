...
bool ChangeCharLiteral::mutate() {
  ...
  switch (newChar) {
  case '\0': newCharStr = "\\0"; break;
  case '\'': newCharStr = "\\\'"; break;
  case '\"': newCharStr = "\\\""; break;
  case '\a': newCharStr = "\\a"; break;
  case '\b': newCharStr = "\\b"; break;
  case '\f': newCharStr = "\\f"; break;
  case '\n': newCharStr = "\\n"; break;
  case '\r': newCharStr = "\\r"; break;
  case '\t': newCharStr = "\\t"; break;
  case '\v': newCharStr = "\\v"; break;
  case '\\': newCharStr = "\\\\"; break;
  default:
